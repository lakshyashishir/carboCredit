...
const NavSideBar = () => {
  ...
  return (
    <motion.div
      ...
      className="fixed top-16 left-0 w-72 h-screen border-r border-white/30 text-black flex flex-col gap-3 pt-7 text-lg font-light tracking-tight leading-6 pr-2 z-50 bg-white shadow-lg"  // Added shadow-lg class
    >
