    ...
    >
      <motion.div variants={verticalVariant} className="p-8">
        ...
        <div className="mb-8 flex justify-end">
          <Select value={timeRange} onValueChange={setTimeRange}>
            <SelectTrigger className="w-[180px] bg-white/10 border-hedera-green/30 text-white">
        ...
        <motion.div variants={verticalVariant} className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <Card className="bg-white/10 backdrop-blur-md border-hedera-green/30">
            <CardHeader>
              <CardTitle className="text-2xl text-hedera-green">Emission Trends</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-white/10 backdrop-blur-md border-hedera-green/30">
            <CardHeader>
              <CardTitle className="text-2xl text-hedera-green">Emission Sources</CardTitle>
            </CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
          ...
          <Card className="bg-white/10 backdrop-blur-md border-hedera-green/30">
            <CardHeader>
              <CardTitle className="text-2xl text-hedera-green">Greenhouse Gas Composition</CardTitle>
            </CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
                <PieChart>
          ...
          <Card className="bg-white/10 backdrop-blur-md border-hedera-green/30">
            <CardHeader>
              <CardTitle className="text-2xl text-hedera-green">Key Metrics</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center">
                  <p className="text-3xl font-bold text-hedera-green">25%</p>
                  <p className="text-sm text-gray-300">Reduction from Last Year</p>
                </div>
                <div className="text-center">
                  <p className="text-3xl font-bold text-hedera-green">10,000</p>
                  <p className="text-sm text-gray-300">Total Credits Earned</p>
                </div>
                <div className="text-center">
                  <p className="text-3xl font-bold text-hedera-green">50 tons</p>
                  <p className="text-sm text-gray-300">Projected Monthly Reduction</p>
                </div>
                <div className="text-center">
                  <p className="text-3xl font-bold text-hedera-green">Gold</p>
        ...
        <motion.div variants={verticalVariant} className="mt-16 w-[90%] mx-auto">
          <h2 className="text-2xl font-semibold mb-4 text-hedera-green">Analytics Features</h2>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            {[
              { title: 'Trend Analysis', icon: <TrendingUp className="h-6 w-6 text-hedera-green" /> },
              { title: 'Source Breakdown', icon: <BarChartIcon className="h-6 w-6 text-hedera-green" /> },
              { title: 'Gas Composition', icon: <PieChartIcon className="h-6 w-6 text-hedera-green" /> },
              { title: 'Real-time Metrics', icon: <Activity className="h-6 w-6 text-hedera-green" /> },
            ].map((item, index) => (
              <motion.div
                key={index}
                variants={verticalVariant}
      ...
      >
        <p className="text-sm text-gray-400">
          Empowering data-driven sustainability decisions through advanced analytics
        </p>
      </motion.footer>
    </motion.div>
  );
